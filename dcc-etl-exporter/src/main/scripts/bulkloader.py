...
def bulkloadData(type):
  ...
  os.system("HADOOP_USER_NAME=hbase hbase org.apache.hadoop.hbase.mapreduce.LoadIncrementalHFiles -Dhbase.mapreduce.bulkload.max.hfiles.perRegion.perFamily=9999 " + tmp_hfile + " " + tablename)
